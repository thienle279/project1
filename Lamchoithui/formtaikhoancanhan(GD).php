...
<?php
include 'ketnoi.php';
$sql = "SELECT sdt, matkhau FROM taikhoan WHERE matk = 10";
...
if ($result->num_rows > 0) {
    ...
    echo "<p>Không tìm thấy thông tin đăng nhập!</p>";
}
...
?>
    <div class="form-container">
        ...
        <form id="doimatkhau-form">
            <input type="text" id="tendangnhap" name="tendangnhap" placeholder="Tên đăng nhập" value="<?php echo $tendangnhap; ?>" required>
