...
$sql1 = "SELECT COUNT(mada) as count1 from duan where status != 'Đã Xóa' and phongban='$mapb'";
...
$sql2 = "SELECT COUNT(mada) as count2 from duan  WHERE trangthai = 'Sắp thực hiện' and status != 'Đã Xóa' and phongban='$mapb'";
...
$sql3 = "SELECT COUNT(mada) as count3 from duan  WHERE trangthai = 'Đang thực hiện' and status != 'Đã Xóa'and phongban='$mapb'";
...
$sql4 = "SELECT COUNT(mada) as count4 from duan  WHERE trangthai = 'Đã hoàn thành' and status != 'Đã Xóa' and phongban='$mapb'";
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    data.forEach(duan => {
                        ...
                        deleteButton.onclick = () => xoaDuAn(duan.mada);  // Gọi hàm xóa dự án
        ...
        cell.style.textAlign = "center";
             ...
             timkiemInput.addEventListener('input', function() {
                ...
                if (tenduan!="") {
                    ...
                    fetch(`timkiem_duan1.php?tenduan=${tenduan}&mapb=${phongbanId}`)
                        .then(response => {
                            if (!response.ok) {
                                throw new Error('Network response was not ok');
                            }
