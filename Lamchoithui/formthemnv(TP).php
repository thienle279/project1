...
<body>
    <form action="themnhanvien(TP).php" id="formthemnv" method="POST" enctype="multipart/form-data">
         <?php
        include 'ketnoi.php';
        ...
        <input type="hidden" name="sdt1" id="sdt1" value="<?php echo $sdt1; ?>">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch('get_phongban.php')
                ...
                .then(data => {
                    // Assuming you want to handle department data here if necessary
                })
            ...
            function saveImageToDatabase(idh) {
                ...
                xhr.open("POST", "themnhanvien(TP).php", true);
