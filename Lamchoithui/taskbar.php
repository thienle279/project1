...
<body>
    ...
    <div class="taskbar">
        <ul>
            <li><a href="formdsphongbannv(GD).php">Phòng Ban</a></li>
            <li><a href="formdsnhanvien(GD).php">Nhân Viên</a></li>
            <li><a href="formdsduan(GD).php">Dự Án</a></li>
            <li><a href="formdstaikhoan(GD).php">Tài Khoản</a></li>
            <li><a href="formtaikhoancanhan(GD).php">Đổi Mật Khẩu</a></li>
        </ul>
    </div>
